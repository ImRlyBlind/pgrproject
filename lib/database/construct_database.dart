import 'package:akproject/model/construct/cons_data.dart';
import 'package:akproject/model/construct/cons_skill_core.dart';

class ConstructDatabase {
  var con_database = [
    ConstructData(name: 'Lucia', frame: 'Crimson Abyss', element: '100% Physical'),
    ConstructData(name: 'Lee', frame: 'Entropy', element: '100% Physical'),
    ConstructData(name: 'Liv', frame: 'Luminance', element: '100% Physical'),
    ConstructData(name: 'Nanami', frame: 'Pulse', element: '50% Physical 50% Fire'),
    ConstructData(name: 'Karenina', frame: 'Ember', element: '30% Physical 70% Fire'),
    ConstructData(name: 'Kamui', frame: 'Tenebrion', element: '50% Physical 50% Dark'),
    ConstructData(name: 'Bianca', frame: 'Veritas', element: '20% Physical 80% Lightning'),
    ConstructData(name: 'Lucia', frame: 'Dawn', element: '40% Physical 60% Lightning'),
    ConstructData(name: 'Liv', frame: 'Lux', element: '20% Physical 80% Lightning'),
    ConstructData(name: 'Lee', frame: 'Palefire', element: '60% Physical 40% Fire'),
    ConstructData(name: 'Bianca', frame: 'Zero', element: '100% Physical'),
    ConstructData(name: 'Karenina', frame: 'Blast', element: '80% Physical 20% Fire'),
    ConstructData(name: 'Watanabe', frame: 'Nightblade', element: '100% Physical'),
    ConstructData(name: 'Kamui', frame: 'Bastion', element: '100% Physical'),
    ConstructData(name: 'Watanabe', frame: 'Astral', element: '50% Physical 50% Dark'),
    ConstructData(name: 'Ayla', frame: 'Brilliance', element: '100% Physical'),
    ConstructData(name: 'Sofia', frame: 'Silverfang', element: '20% Physical 80% Fire'),
    ConstructData(name: 'Lucia', frame: 'Lotus', element: '80% Physical 20% Fire'),
    ConstructData(name: 'Liv', frame: 'Eclipse', element: '100% Physical'),
    ConstructData(name: 'Nanami', frame: 'Storm', element: '100% Physical'),
  ];
